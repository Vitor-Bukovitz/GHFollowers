...
enum PersistenceManager {
    ...
    static func updaetWithFavorite(favorite: Follower, actionType: PersistanceActionType, completed: @escaping (GFError?) -> Void) {
            ...
            case .success(let favorites):
                ...
                case .add:
                    guard !retrieveFavorites.contains(favorite) else {
                        return completed(GFError.alreadyInFavorites)
                    }
